...
st.html(
    ...
    * {
    ...
    .hero-box::after {
        ...
        animation:
            heroLight 5s ease-in-out infinite;
    }
    ...
    .movie-wrapper::before {
        ...
        animation:
            cardLightning 3.5s linear infinite;
